...
covariates <- stack(elevation, tot_inso, aspect, slope, visual_prom, tpi100, wetness_cost, geol_cost, hydro_cost, lcp_c, wind, tpi500)
names(covariates) <- c("elevation", "tot_inso", "aspect", "slope", "visual_prom", "tpi100", "wetness_cost", "geol_cost","hydro_cost", "lcp_c", "wind", "tpi500")
