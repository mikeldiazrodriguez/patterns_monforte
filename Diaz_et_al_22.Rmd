...
par(mfrow=c(1,1))
png(file = "~/Figure2.png",width = 900,height = 1200)
dev.off()
```
...
# Export file
png(file = "~/Figure3.png",width = 900,height = 1200)
```
...
```{r echo=TRUE, results='hide'}
par(mar=c(4, 4, 4, 4), mfrow=c(3,2))
plot(elevation.rh, main="a. Altitude", xlab="m.a.s.l.", ylab="", legend=FALSE, cex.axis=0.9)
plot(d_rivers.rh, main="b. Cost to potential hydrology cells", xlab="Seconds", ylab="", legend=FALSE, cex.axis=0.9)
plot(d_edges.rh, main="c. Cost to potential wetland cells", xlab="Seconds", ylab="", legend=FALSE, cex.axis=0.9)
plot(tviewshed.rh, main="d. Visual Prominence", xlab="Visible cells number", ylab="", legend=FALSE, cex.axis=0.9)
plot(slope.rh, main="e. Slope", xlab="Degrees", ylab="", legend=FALSE, cex.axis=0.9)
par(mfrow=c(1,1))
png(file = "~/Figure5.png",width = 900,height = 1200)
dev.off()
```
